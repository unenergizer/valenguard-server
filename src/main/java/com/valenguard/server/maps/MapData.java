...
public class MapData {
    ...
    public synchronized void addPlayer(Player player) {
        ...
        System.out.println("Added " + player.getClientHandler().getClientSocket().getInetAddress() + " to map " + mapName + ".");
    ...
    public synchronized void removePlayer(Player player) {
        ...
        System.out.println("Removed " + player.getClientHandler().getClientSocket().getInetAddress() + " from map " + mapName + ".");
        System.out.println("Map " + mapName + " now has " + playerList.size() + " players.");
    }
